...
library(reticulate)
use_python('/home/tim/anaconda3/bin/')
use_condaenv(condaenv = "lib-py")
...
For this lesson, we will use head count data provided by USC's Leavey Library. The data is available [here](https://drive.google.com/file/d/0B8w7idDSiacWLVBVenpKMUVQT242SUotM3RIZ3lUMGNOOTQ0/view?usp=sharing). You can download this to your working directory and put inside a `data/` folder (create that folder if it doesn't exist).

This data is a 

```{python, show-data, echo=FALSE}
x = pd.read_csv('/home/tim/carpentries/lessons/library-python/data/SampleDataOctober2017HeadAndExitCounts.csv')
x.head
```
